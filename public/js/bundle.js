...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // this is mean to put the map within an element with the id of map
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add a marker 
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              if (['/me', '/my-bookings', '/submit-user-data', '/my-reviews', '/tour/the-sea-explorer/create-review'].includes(location.pathname)) location.assign('/');else location.reload(true); // with true it will force the reload from the server and not from the browser cache
            }
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(creds) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showAlert)('success', 'Check out your email inbox');
              window.setTimeout(function () {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(token, password, passwordConfirm) {
    var res;
  ...
  return function resetPassword(_x5, _x6, _x7) {
...
var stripe = Stripe('pk_test_51JW8IgCwIKkanm5pjdLSAFLq9YJefZTSLafWjuPVJa70HJljYA1QcgA9R8zU5cJXF6VDjMAc6ZLFikXcyFvOBJCp008ym3pN26');
...
exports.editReview = exports.deleteReview = exports.createReview = void 0;
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, tour, tourSlug) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review is created successfuly!');
              window.setTimeout(function () {
                location.assign("/tour/".concat(tourSlug));
              }, 5000);
            }
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(reviewId) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            result = confirm("Are you sure you want to delete this review?");
          ...
          case 5:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Review is deleted successfuly!');
              window.setTimeout(function () {
                location.reload(true);
              }, 5000);
            }
...
var editReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(rating, review, reviewId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 200) {
              (0, _alerts.showAlert)('success', 'Yor review is updated successfully');
              setTimeout(function () {
  ...
  return function editReview(_x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();

exports.editReview = editReview;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"tours.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createTour = exports.getTour = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.status === 200) {
              (0, _alerts.showAlert)('success', 'Tour is created successfully!');
            }
...
var userMenu = document.getElementById('user-menu-icon');
...
var manageCreateTourBtn = document.querySelector('.manage-create-btn-tours');
var manageCreateTourForm = document.getElementById('create-tour-form'); // VALUES
// DELEGATION
...
if (createReviewBtnTourDetail) {
  var tourSlug = createReviewBtnTourDetail.dataset.tourSlug;
  createReviewBtnTourDetail.addEventListener('click', function (e) {
    location.assign("/tour/".concat(tourSlug, "/create-review"));
  });
}

if (createReviewBtnFormInput) {
  createReviewBtnFormInput.addEventListener('click', function (e) {
    e.preventDefault();
    var tourId = createReviewBtnFormInput.dataset.tourId;
    var tourSlug = createReviewBtnFormInput.dataset.tourSlug;
    var rating = document.querySelector('input[name="rate"]:checked') ? document.querySelector('input[name="rate"]:checked').value : 0;
    var msg = document.getElementById('edit-text').value; // console.log(msg, rating, tourId, tourSlug);

    (0, _reviews.createReview)(msg, rating, tourId, tourSlug);
  });
}
...
if (editMyReviewButtonFormInput) {
  editMyReviewButtonFormInput.addEventListener('click', function (e) {
    e.preventDefault();
    var rating = document.querySelector('input[name="rate"]:checked') ? document.querySelector('input[name="rate"]:checked').value : 0;
    var msg = document.getElementById('edit-text').value;
    (0, _reviews.editReview)(rating, msg, document.getElementById('edit-text').dataset.reviewId);
  });
}
...
if (searchButton) {
  searchButton.addEventListener('click', function (e) {
    ...
    location.assign("/tours/search?name=".concat(searchQuery));
  });
}

if (manageCreateTourBtn) {
  manageCreateTourBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (manageCreateTourForm) {
  manageCreateTourForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('manage-create-tour-name').value;
    var duration = document.getElementById('manage-create-tour-duration').value;
    var maxGroupSize = document.getElementById('manage-create-tour-max-group-size').value;
    var difficulty = document.getElementById('manage-create-tour-difficulty').value;
    var price = document.getElementById('manage-create-tour-price').value; // const priceDiscount = document.getElementById('manage-create-tour-price-discount').value;

    var summary = document.getElementById('manage-create-tour-sumamry').value; // const description = document.getElementById('manage-create-tour-description').value;

    var imageCover = document.getElementById('manage-create-tour-image-cover').files[0].name; // const leadGuide = document.getElementById('manage-create-tour-lead-guide').value;
